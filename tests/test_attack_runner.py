...
from krucible.attacks.payloads.strategies import PromptInjectionStrategy, JailbreakStrategy
...
def test_runner_executes_attack_and_returns_domain_result(runner):
    ...
    attack = Attack(id="atk-1", type="injection", name="SQLi", description="Test", payload="DROP TABLE", tags=[])
...
def test_runner_handles_unregistered_strategy(runner):
    ...
    attack = Attack(id="atk-2", type="unsupported-type", name="Test", description="Test", payload="Test", tags=[])
