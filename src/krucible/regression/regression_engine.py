...
from krucible.domain.models import Evaluation, Baseline, Regression
...
class RegressionEngine:
    ...
    def save_baseline(self, baseline_id: str, evaluations: List[Evaluation], metadata: Dict[str, str] = None) -> Baseline:
